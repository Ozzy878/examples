...
def run_excel(args):
    ...
    try:
        ...
        for fname in args[1:]:
            ...
            wb.Sheets("Unit Sales by Food Category").PivotTables(ptname).PivotFields(
                "Fiscal Quarter").CurrentPage = "2009-Q4"
        ...
        if sawerror:
            ...
            ctypes.windll.user32.MessageBoxW(None, "Error: Problems occurred, please check them and try again",
                                             "erppivotdragdrop", 0)
        else:
